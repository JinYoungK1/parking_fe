...
function CustomPopTable<T>(props: TableProps<T>) {
  ...
  return (
    <div className={'overflow-x-auto overflow-y-auto'}>
      <div className="inline-block min-w-full p-1.5 align-middle">
        <div className="table-container max-h-[400px] w-full overflow-x-auto  p-1.5">
        {/* className=" " */}
          ...
          {/* className={'bg-slate-600'} */} 
            ...
            <thead className='bg-slate-600 z-8 sticky top-0 border-black text-center'>
                  ...
                  <tr key={headerGroup.id} className="w-full">
                    {headerGroup.headers.map((header) => {
                      return (
                        <th
                          key={header.id}
                          style={{ width: header.getSize() }} // 동적 크기 적용
                    ...
                    {row.getVisibleCells().map((cell) => {
                      return (
                        <td
                          key={cell.id}
                          className={clsx(
                            'text-md cursor-pointer whitespace-nowrap border-l border-r px-4 py-1 text-center text-gray-800',
                            {
